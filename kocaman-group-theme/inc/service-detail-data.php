...
function kocaman_get_service_detail( $key ) {
	$data = array(
		'insaat'      => array(
			...
			'gallery'    => array(
				array( 'file' => 'insaat-gal-01.png', 'alt' => __( 'Günbatımında modern üç katlı lüks villa — havuz ve çağdaş cephe', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-02.png', 'alt' => __( 'Örnek konut iç mekânı — açık plan stüdyo suite, mutfak ve yatak alanı', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-03.png', 'alt' => __( 'Yan yana ikiz villalar — günbatımı, özel havuzlar ve peyzaj', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-04.png', 'alt' => __( 'Havadan görünüm: ikiz villa projesi, havuz ve altın saat ışığı', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-05.png', 'alt' => __( 'Ev ofisi — cam cephe, mermer zemin ve özel çalışma alanı', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-06.png', 'alt' => __( 'Günbatımında lüks villa — havuz, teras ve manzaralı bahçe', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-07.png', 'alt' => __( 'Modern arka bahçe — yüzme havuzu, kapalı teras ve dinlenme alanı', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-08.png', 'alt' => __( 'Alçak açıdan çağdaş villa cephesi — ahşap detay ve günbatımı', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-09.png', 'alt' => __( 'Özel giyinme odası — aydınlatmalı dolaplar ve düzenli depolama', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-10.png', 'alt' => __( 'Çocuk odası — modern mobilya ve doğal ışık', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-11.png', 'alt' => __( 'Konut içi merdiven ve yaşam alanı — taş basamak ve sıcak aydınlatma', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-12.png', 'alt' => __( 'Ebeveyn yatak odası — geniş alan ve katmanlı aydınlatma', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-13.png', 'alt' => __( 'Özel yüzme havuzu ve modern bahçe çitleri — gün ışığında dış mekân', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-14.png', 'alt' => __( 'Açık plan mutfak, yemek ve salon — mermer zemin ve entegre aydınlatma', 'kocaman-group' ) ),
				array( 'file' => 'insaat-gal-15.png', 'alt' => __( 'Köşe parselde modern villa — sokak görünümü ve günbatımı', 'kocaman-group' ) ),
			),
